...
from py-beastx.startup.loader import load_addons

from . import eod, eor, get_string, requests, safeinstall, beastx_cmd, un_plug


@beastx_cmd(pattern="install", fullsudo=True)
...
@beastx_cmd(pattern="getaddons ?(.*)", fullsudo=True)
