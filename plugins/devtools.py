...
@beastx_cmd(pattern="bash", fullsudo=True, only_devs=True)
async def _(event):
...
bot = ultroid = beastx_bot


@beastx_cmd(pattern="eval", fullsudo=True, only_devs=True)
async def _(event):
...
@beastx_cmd(pattern="cpp", only_devs=True)
async def doie(e):
