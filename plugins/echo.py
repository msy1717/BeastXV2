...
from py-beastx.dB.echo_db import add_echo, check_echo, list_echo, rem_echo
from telethon.utils import get_display_name

from . import LOGS, eor, events, beastx_bot, beastx_cmd


@beastx_cmd(pattern="addecho ?(.*)")
async def echo(e):
