...
from py-beastx import HNDLR, LOGS, asst, mrunal, vcClient
...
from py-beastx.functions.admins import admin_check
from py-beastx.functions.tools import is_url_ok
from py-beastx.functions.ytdl import get_videos_link
from py-beastx.functions.info import get_user_id
from py-beastx.dB.vc_group import check_vcauth, get_chats as get_vc
from py-beastx.misc import owner_and_sudos, sudoers
from py-beastx.misc._assistant import in_pattern
from py-beastx.misc._wrappers import eod, eor
from py-beastx.version import __version__ as UltVer
...
LOG_CHANNEL = int(mrunal["LOG_CHANNEL"])
...
def VC_AUTHS():
    _vcsudos = mrunal["VC_SUDOS"].split() if mrunal.get("VC_SUDOS") else ""
...
def vc_asst(dec, **kwargs):
    def ult(func):
        ...
        handler = mrunal["VC_HNDLR"] if mrunal.get("VC_HNDLR") else HNDLR
